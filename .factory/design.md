...
- `site/assets/social-card.webp`: a 1200×630 center crop of the project-original impossible archive artwork, composed locally with ImageMagick on 2026-08-30. It is the Open Graph and Twitter image and carries the same project-original generated-asset license.
- `site/assets/apple-touch-icon.png`: a 180×180 raster composition of the project’s original folder mark, made locally with ImageMagick on 2026-08-30. It uses the recorded night and mist palette and has no third-party source material.
